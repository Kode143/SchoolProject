...
const SliderForm = () => {
  ...
  async function handleUpload(e) {
    ...
    if (files.length > 4) return alert('Upload up to 4 images.');
    ...
    try {
      ...
      const mongoResponse = await axios.post('/api/sliders', { images });
...
<div className="flex justify-between">
    ...
    (*) Only accept image files less than 25MB in size. up to 4 photo files.
  </h1>
            </div>
